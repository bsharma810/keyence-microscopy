...
<SavingImageSize Type="Keyence.Micro.Bio.Common.Utility.KeyValueContainer.SizeKeyValueContainer, Keyence.Micro.Bio.Common.Utility.KeyValueContainer, Version=1.1.2.14, Culture=neutral, PublicKeyToken=null">
<Width Type="System.Int32">480</Width>
<Height Type="System.Int32">360</Height>
</SavingImageSize>
...
<RevolverPosition Type="System.Int32">0</RevolverPosition>
</Lens>


<XyStageRegion Type="Keyence.Micro.Bio.Common.Utility.KeyValueContainer.RectangleKeyValueContainer, Keyence.Micro.Bio.Common.Utility.KeyValueContainer, Version=1.1.2.14, Culture=neutral, PublicKeyToken=null">
<X Type="System.Int32">28177000</X>
<Y Type="System.Int32">59189000</Y>
...
<Line Type="System.Int32">761</Line>
    ...
    def __init__(self, tif: str):
        ...
        self.image_positions: tuple[float] = None       # initialize image position
        self.dimensions: tuple[int] = None              # initialize image dimensions
        self.nm_per_pixel_values: float = None          # initialize pixel size in nm
        self.lens_name = None                           # initialize lenz name
        self.exposure_time = None                        # initialize exp time
        ...
        if SAVE_XML:
            ...
            print(f"XML not saved for {self.__xml_file}")
        ...
        self.nm_per_pixel_values = int(region.find('Width').text) / self.dimensions[0]  # Conversion factor
